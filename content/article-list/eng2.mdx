...
summary: 'Analogy:  Painting and its relation to  various server side and client side rendering advantages'
excerpt: 'When I think of rendering a webpage I liken it to creating a piece of art.'
imageLink: '/assets/images/article-images/brushes.svg'
